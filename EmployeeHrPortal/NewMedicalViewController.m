...
-(void)GetApplicantValues{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GetApplicantValues xmlns=\"http://webserv.kontract360.com/\">\n"
                   "<AppId>%d</AppId>"
                   "</GetApplicantValues>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_Applicantid];
    ...
    [theRequest addValue: @"http://webserv.kontract360.com/GetApplicantValues" forHTTPHeaderField:@"Soapaction"];
...
-(void)DeleteApplicantMedicalCondition{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<DeleteApplicantMedicalCondition xmlns=\"http://webserv.kontract360.com/\">\n"
                   "<AppId>%d</AppId>\n"
                    "<MedConditionId>%d</MedConditionId>"
    ...
    [theRequest addValue: @"http://webserv.kontract360.com/DeleteApplicantMedicalCondition" forHTTPHeaderField:@"Soapaction"];
