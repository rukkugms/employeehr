...
-(void)SelectApplicantCertificates{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectApplicantCertificates xmlns=\"http://testUSA.kontract360.com/\">\n"
                     "<AppId>%d</AppId>\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue:@"http://testUSA.kontract360.com/SelectApplicantCertificates" forHTTPHeaderField:@"Soapaction"];
...
-(void)SelectApplicantEducation{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<SelectApplicantEducation xmlns=\"http://testUSA.kontract360.com/\">\n"
                   "<AppId>%d</AppId>\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue:@"http://testUSA.kontract360.com/SelectApplicantEducation" forHTTPHeaderField:@"Soapaction"];
...
-(void)InsertApplicantCertificates{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<InsertApplicantCertificates xmlns=\"http://testUSA.kontract360.com/\">\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue:@"http://testUSA.kontract360.com/InsertApplicantCertificates" forHTTPHeaderField:@"Soapaction"];
...
-(void)InsertApplicantEducation{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<InsertApplicantEducation xmlns=\"http://testUSA.kontract360.com/\">\n"
                   "<ApplicantId>%d</ApplicantId>\n"
                   "<EduId>%d</EduId>\n"
                   "<EduName>%@</EduName>\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue:@"http://testUSA.kontract360.com/InsertApplicantEducation" forHTTPHeaderField:@"Soapaction"];
...
-(void)DeleteApplicantEducation
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<DeleteApplicantEducation xmlns=\"http://testUSA.kontract360.com/\">\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue:@"http://testUSA.kontract360.com/DeleteApplicantEducation" forHTTPHeaderField:@"Soapaction"];
...
-(void)DeleteApplicantCertificates
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<DeleteApplicantCertificates xmlns=\"http://testUSA.kontract360.com/\">\n"
                   "<CertificateId>%d</CertificateId>\n"
                   "<AppId>%d</AppId>\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue:@"http://testUSA.kontract360.com/DeleteApplicantCertificates" forHTTPHeaderField:@"Soapaction"];
