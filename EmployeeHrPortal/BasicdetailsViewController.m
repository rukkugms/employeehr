...
-(void)GetApplicantDetails{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<GetApplicantDetails xmlns=\"http://testUSA.kontract360.com/\">\n"
                    "<AppId>%d</AppId>\n"
                    "</GetApplicantDetails>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n",_Applicantid];
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue:@"http://testUSA.kontract360.com/GetApplicantDetails" forHTTPHeaderField:@"Soapaction"];
...
-(void)UpdateApplicantData{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<UpdateApplicantData xmlns=\"http://testUSA.kontract360.com/\">\n"
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue:@"http://testUSA.kontract360.com/UpdateApplicantData" forHTTPHeaderField:@"Soapaction"];
...
-(void)getstates
{
    ...
    soapMessage = [NSString stringWithFormat:
                   ...
                   "<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">\n"
                   "<soap:Body>\n"
                   "<SelectState xmlns=\"http://testUSA.kontract360.com/\">\n"
                   "</SelectState>\n"
                   "</soap:Body>\n"
                   "</soap:Envelope>\n"];
    NSLog(@"soapmsg%@",soapMessage);
   ...
   NSURL *url = [NSURL URLWithString:@"http://testusa.kontract360.com/service.asmx"];
    ...
    [theRequest addValue:@"http://testUSA.kontract360.com/SelectState" forHTTPHeaderField:@"Soapaction"];
